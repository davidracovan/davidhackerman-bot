...
class Links(commands.Cog):
    ...
    async def safety(self, ctx):
        ...
        embed = tools.create_embed(ctx, 'Safety Dance', url='https://www.youtube.com/watch?v=AjPau5QYtYs')
    ...
    async def tainted(self, ctx):
        ...
        embed = tools.create_embed(ctx, 'Tainted Love', url='https://www.youtube.com/watch?v=ZcyCQLewj10')
        await ctx.send(embed=embed)
        await self.bot.get_cog('Economy').command_coins(ctx)
